...
public class AssetTests
{
    ...
    public void Constructor_Should_Set_Properties_And_Raise_AssetCreated()
    {
        ...
        var asset = new AudioAsset("ext-1", metadata, 808, 3233, 15);
    ...
    {
        var asset = new AudioAsset("ext-2", new Metadata("t", null, null), 808, 3233, 15);
    ...
    {
        var asset = new AudioAsset("ext-3", new Metadata("t", null, null), 808, 3233, 15);
    ...
    {
        var asset = new AudioAsset("ext-4", new Metadata("t", null, null), 808, 3233, 15);
    ...
    {
        var asset = new AudioAsset("ext-5", new Metadata("t", null, null), 808, 3233, 15);
    ...
    {
        var asset = new AudioAsset("ext-6", new Metadata("t", null, null), 808, 3233, 15);
    ...
    {
        var asset = new AudioAsset("ext-7", new Metadata("t", null, null), 808, 3233, 15);
        asset.Archive(_ => false);
        asset.Archive(_ => false);
        asset.Archived.ShouldBeTrue();
